#ifndef SC_TUPLE_3_INC
#   define SC_TUPLE_3_INC
...
class Tuple3
{
    public:
        ...
        */
         ...
         * reference to y, else reference to z coordinate.
         */
        T& operator [] (int n)
        {
            assert(n >= 0 && n <= 2);
         ...
         * this = s*this + t1
         */
        void self_scale_add(T s, const Tuple3<T>& t1)
        {
            x = x * s + t1.x;
            y = y * s + t1.y;
            z = z * s + t1.z;
         ...
         * this = s*t1 + t2
         */
        void scale_add(T s, const Tuple3<T>& t1, const Tuple3<T>& t2)
        {
            x = s*t1.x + t2.x;
            y = s*t1.y + t2.y;
            z = s*t1.z + t2.z;
        ...
        /*! this = this + s*t1 */
        void scale_add(T s, const Tuple3<T>& t1)
        {
            x += s*t1.x;
            y += s*t1.y;
            z += s*t1.z;
