...
namespace protobuf_sploosh_2eproto {
...
void InitDefaultsFMMomentsImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_sploosh_2eproto::InitDefaultsVector3d();
  {
...
void InitDefaultsModalMomentsImpl() {
  ...
  ::google::protobuf::internal::InitProtobufDefaults();
#endif  // GOOGLE_PROTOBUF_ENFORCE_UNIQUENESS
  protobuf_sploosh_2eproto::InitDefaultsFMMoments();
  {
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "sploosh.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "moment\030\001 \003(\0132\022.sploosh.FMMoments"
  };
...
const ::google::protobuf::Descriptor* Vector3d::descriptor() {
  ::protobuf_sploosh_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_sploosh_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}
...
::google::protobuf::Metadata Vector3d::GetMetadata() const {
  protobuf_sploosh_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_sploosh_2eproto::file_level_metadata[kIndexInFileMessages];
}
...
Complexd::Complexd()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_sploosh_2eproto::InitDefaultsComplexd();
  }
  SharedCtor();
...
ModalMoments::ModalMoments()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_sploosh_2eproto::InitDefaultsModalMoments();
  }
  SharedCtor();
