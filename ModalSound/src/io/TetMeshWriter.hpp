...
#ifdef USE_NAMESPACE
    template <typename T>
    static int write_mesh(const char* filename, const sploosh::TetMesh<T>& mesh);
#else
    template <typename T>
...
#ifdef USE_NAMESPACE
template <typename T>
int AbaqusMeshWriter::write_mesh(const char* filename, const sploosh::TetMesh<T>& mesh)
#else
template <typename T>
...
#ifdef USE_NAMESPACE
    template <typename T>
    static int write_mesh(const char* filename, const sploosh::FixedVtxTetMesh<T>& mesh);
#else
    template <typename T>
    static int write_mesh(const char* filename, const FixedVtxTetMesh<T>& mesh);
#endif
};

#ifdef USE_NAMESPACE
template <typename T>
int FV_AbaqusMeshWriter::write_mesh(const char* filename, const sploosh::FixedVtxTetMesh<T>& mesh)
#else
template <typename T>
int FV_AbaqusMeshWriter::write_mesh(const char* filename, const FixedVtxTetMesh<T>& mesh)
#endif
{
    using namespace std;
    ofstream fout(filename);
...
#ifdef USE_NAMESPACE
template <typename T>
int TetMeshWriter_Double::write_mesh(const char* filename, const sploosh::TetMesh<T>& mesh)
#else
template <typename T>
...
int FV_TetMeshWriter_Double::write_mesh(const char* filename, 
        const sploosh::FixedVtxTetMesh<T>& mesh)
#else
template <typename T>
int FV_TetMeshWriter_Double::write_mesh(
        const char* filename, const FixedVtxTetMesh<T>& mesh)
#endif
{
#ifdef USE_NAMESPACE
    using namespace sploosh;
